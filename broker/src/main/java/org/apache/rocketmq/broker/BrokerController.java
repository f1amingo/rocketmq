...
public class BrokerController {
    ...
    public void registerProcessor() {
        ...
        remotingServer.registerProcessor(RequestCode.SEND_MESSAGE_V2, sendMessageProcessor, sendMessageExecutor);
        remotingServer.registerProcessor(RequestCode.SEND_BATCH_MESSAGE, sendMessageProcessor, sendMessageExecutor);
        remotingServer.registerProcessor(RequestCode.CONSUMER_SEND_MSG_BACK, sendMessageProcessor, sendMessageExecutor);

        fastRemotingServer.registerProcessor(RequestCode.SEND_MESSAGE, sendMessageProcessor, sendMessageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.SEND_MESSAGE_V2, sendMessageProcessor, sendMessageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.SEND_BATCH_MESSAGE, sendMessageProcessor, sendMessageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.CONSUMER_SEND_MSG_BACK, sendMessageProcessor, sendMessageExecutor);
        ...
        remotingServer.registerProcessor(RequestCode.LITE_PULL_MESSAGE, pullMessageProcessor, litePullMessageExecutor);

        /*
         * PeekMessageProcessor
         */
        remotingServer.registerProcessor(RequestCode.PEEK_MESSAGE, peekMessageProcessor, pullMessageExecutor);

        /*
         * PopMessageProcessor
         */
        remotingServer.registerProcessor(RequestCode.POP_MESSAGE, popMessageProcessor, pullMessageExecutor);

        /*
         * AckMessageProcessor
         */
        remotingServer.registerProcessor(RequestCode.ACK_MESSAGE, ackMessageProcessor, ackMessageExecutor);
        remotingServer.registerProcessor(RequestCode.BATCH_ACK_MESSAGE, ackMessageProcessor, ackMessageExecutor);

        fastRemotingServer.registerProcessor(RequestCode.ACK_MESSAGE, ackMessageProcessor, ackMessageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.BATCH_ACK_MESSAGE, ackMessageProcessor, ackMessageExecutor);

        /*
         * ChangeInvisibleTimeProcessor
         */
        remotingServer.registerProcessor(RequestCode.CHANGE_MESSAGE_INVISIBLETIME, changeInvisibleTimeProcessor, ackMessageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.CHANGE_MESSAGE_INVISIBLETIME, changeInvisibleTimeProcessor, ackMessageExecutor);

        /*
         * notificationProcessor
         */
        remotingServer.registerProcessor(RequestCode.NOTIFICATION, notificationProcessor, pullMessageExecutor);

        /*
         * pollingInfoProcessor
         */
        remotingServer.registerProcessor(RequestCode.POLLING_INFO, pollingInfoProcessor, pullMessageExecutor);
        ...
        remotingServer.registerProcessor(RequestCode.UNREGISTER_CLIENT, clientManageProcessor, clientManageExecutor);
        remotingServer.registerProcessor(RequestCode.CHECK_CLIENT_CONFIG, clientManageProcessor, clientManageExecutor);

        fastRemotingServer.registerProcessor(RequestCode.HEART_BEAT, clientManageProcessor, heartbeatExecutor);
        fastRemotingServer.registerProcessor(RequestCode.UNREGISTER_CLIENT, clientManageProcessor, clientManageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.CHECK_CLIENT_CONFIG, clientManageProcessor, clientManageExecutor);

        /*
         * ConsumerManageProcessor
         */
        ConsumerManageProcessor consumerManageProcessor = new ConsumerManageProcessor(this);
        remotingServer.registerProcessor(RequestCode.GET_CONSUMER_LIST_BY_GROUP, consumerManageProcessor, consumerManageExecutor);
        remotingServer.registerProcessor(RequestCode.UPDATE_CONSUMER_OFFSET, consumerManageProcessor, consumerManageExecutor);
        remotingServer.registerProcessor(RequestCode.QUERY_CONSUMER_OFFSET, consumerManageProcessor, consumerManageExecutor);

        fastRemotingServer.registerProcessor(RequestCode.GET_CONSUMER_LIST_BY_GROUP, consumerManageProcessor, consumerManageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.UPDATE_CONSUMER_OFFSET, consumerManageProcessor, consumerManageExecutor);
        fastRemotingServer.registerProcessor(RequestCode.QUERY_CONSUMER_OFFSET, consumerManageProcessor, consumerManageExecutor);
         ...
         */
        remotingServer.registerProcessor(RequestCode.END_TRANSACTION, endTransactionProcessor, endTransactionExecutor);
        fastRemotingServer.registerProcessor(RequestCode.END_TRANSACTION, endTransactionProcessor, endTransactionExecutor);
